...
translation_unit
	: external_declaration											{printf("ACCEPT\n");exit(0);}//printf("**start symbol** transunit->extern\n");exit(0);}
	| translation_unit external_declaration							{printf ( "ACCEPT\n");exit(0);}//printf("**start symbol** transunit->transunit extern\n");exit(0);}
	;
